...
public class SnapshottingEntityLifecycleHandler<I, E> implements EntityLifecycleHandler<I, E> {
    ...
    public E initialize(I identifier, ProcessingContext context) {
        return evolver.initialize(identifier, context);
    }
    ...
    /*
     * Internal exception to signal incompatible snapshots, triggering a fallback
     * full sourcing. This exception never escapes to the callers of this class.
     */
    private static class SnapshotIncompatibleException extends RuntimeException {}
