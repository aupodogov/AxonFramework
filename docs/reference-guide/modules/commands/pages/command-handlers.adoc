...
In Axon Framework, commands are the primary driver of all state changes.
...
For full documentation on event-sourced entities, entity hierarchies, and polymorphism, see xref:commands:entities/index.adoc[Entities].
...
For a full guide to event-sourced entities (including configuration, snapshots, and child entities), see xref:commands:entities/index.adoc[Entities].
