...
- xref:commands:entities/stateful-command-handler.adoc[Stateful command handlers]: how to structure handlers by use case using Vertical Slice Architecture
